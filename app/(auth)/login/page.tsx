...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-[#f6f6f8] dark:bg-[#101622] font-display text-slate-900 dark:text-white antialiased overflow-x-hidden selection:bg-primary/30 selection:text-white">
      ...
      <div className="flex h-full grow flex-col relative z-10 justify-center items-center p-4 md:p-8">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-10 md:mb-14 max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2 dark:text-white text-slate-900">
            Kantra Camera
          </h1>
          <p className="text-slate-500 dark:text-[#9da6b9] text-base md:text-lg font-normal">
        ...
        <div className="w-full max-w-[1000px] grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {/* Card 1: Admin Login */}
          <div className="group flex flex-col bg-white dark:bg-[#1e293b] rounded-2xl border border-slate-200 dark:border-white/5 shadow-xl p-6 md:p-8 relative overflow-hidden">
            {/* Top decoration line */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50"></div>
            
            <div className="mb-6 flex items-center gap-3">
              <span className="material-symbols-outlined text-primary text-2xl">admin_panel_settings</span>
              <h2 className="text-xl font-bold dark:text-white text-slate-900">Quản trị viên (Admin)</h2>
            </div>

            <form className="flex flex-col gap-5 flex-1" onSubmit={handleAdminLogin}>
              {/* Email/Username */}
              <label className="flex flex-col gap-2">
                <span className="text-sm font-medium dark:text-slate-200 text-slate-700">Email hoặc Tên đăng nhập</span>
                <input
                  className="w-full h-12 rounded-lg bg-slate-50 dark:bg-[#282e39] border border-slate-200 dark:border-[#334155] focus:border-primary focus:ring-1 focus:ring-primary dark:text-white text-slate-900 placeholder:text-slate-400 dark:placeholder:text-[#9da6b9] px-4 transition-colors outline-none"
              ...
              <label className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium dark:text-slate-200 text-slate-700">Mật khẩu</span>
                </div>
                <div className="relative">
                  <input
                    className="w-full h-12 rounded-lg bg-slate-50 dark:bg-[#282e39] border border-slate-200 dark:border-[#334155] focus:border-primary focus:ring-1 focus:ring-primary dark:text-white text-slate-900 placeholder:text-slate-400 dark:placeholder:text-[#9da6b9] px-4 pr-12 transition-colors outline-none"
                    placeholder="••••••••"
                  ...
                  <button
                    type="button"
                    className="absolute right-0 top-0 h-full px-4 flex items-center text-slate-400 hover:text-primary transition-colors cursor-pointer"
              ...
              <div className="flex items-center justify-between mt-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    className="rounded bg-slate-100 dark:bg-[#282e39] border-transparent focus:ring-offset-0 focus:ring-primary text-primary w-4 h-4"
                    type="checkbox"
                  />
                  <span className="text-xs text-slate-500 dark:text-slate-400">Ghi nhớ</span>
                </label>
          ...
          <div className="group flex flex-col bg-white dark:bg-[#1e293b] rounded-2xl border border-slate-200 dark:border-white/5 shadow-xl p-6 md:p-8">
            <div className="mb-6 flex items-center gap-3">
              <span className="material-symbols-outlined text-emerald-500 text-2xl">badge</span>
              <h2 className="text-xl font-bold dark:text-white text-slate-900">Nhân viên (Employee)</h2>
            </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <form className="flex flex-col gap-5" onSubmit={handleEmployeeLogin}>
                <label className="flex flex-col gap-2">
                  <span className="text-sm font-medium dark:text-slate-200 text-slate-700">Email công việc</span>
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
                      <span className="material-symbols-outlined text-[20px]">mail</span>
                    </span>
                    <input
                      className="w-full h-12 rounded-lg bg-slate-50 dark:bg-[#282e39] border border-slate-200 dark:border-[#334155] focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 dark:text-white text-slate-900 placeholder:text-slate-400 dark:placeholder:text-[#9da6b9] pl-11 pr-4 transition-colors outline-none"
                ...
                <div className="pt-6 mt-auto">
                  <button
                    ...
                    className="w-full flex items-center justify-center h-12 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-emerald-500 dark:hover:border-emerald-500 hover:text-emerald-500 dark:hover:text-emerald-400 bg-transparent text-slate-700 dark:text-slate-200 font-bold transition-all group-hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        <div className="mt-12 flex flex-col gap-4 text-center">
          ...
          <div className="flex justify-center gap-6">
            <a className="text-xs text-slate-500 dark:text-slate-500 hover:text-white transition-colors" href="#">
              Điều khoản sử dụng
            </a>
            <a className="text-xs text-slate-500 dark:text-slate-500 hover:text-white transition-colors" href="#">
              Chính sách bảo mật

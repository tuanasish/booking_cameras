    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <header className="flex h-16 items-center justify-between border-b border-border bg-surface px-6">
        <div className="flex items-center gap-3">
          <h1 className="text-xl font-bold text-text-main">Đơn thuê</h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 bg-surface p-4 rounded-xl border border-border">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-background border border-border rounded-lg py-2 pl-10 pr-4 text-sm text-text-main focus:ring-1 focus:ring-primary focus:border-primary placeholder:text-text-secondary/50 outline-none"
            />
          </div>
      ...
      <div className="flex-1 overflow-hidden p-6">
        <div className="h-full border border-border rounded-xl bg-surface overflow-hidden flex flex-col shadow-xl">

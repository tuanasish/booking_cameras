...
const platformIcons: Record<string, React.ReactNode> = {
  IG: <span className="material-symbols-outlined text-[12px]">photo_camera</span>,
  ZL: (
    <svg viewBox="0 0 50 50" className="size-3" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M25.814 19.6924C23.1979 19.6924 21.0747 21.8156 21.0747 24.4317C21.0747 27.0478 23.1979 29.171 25.814 29.171C28.4301 29.171 30.5533 27.0478 30.5533 24.4317C30.5533 27.0478 28.4301 29.171 25.814 29.171ZM25.814 27.2184C24.2785 27.2184 23.0273 25.9672 23.0273 24.4317C23.0273 22.8962 24.2785 21.645 25.814 21.645C27.3495 21.645 28.6007 22.8962 28.6007 24.4317C28.6007 25.9672 27.3685 27.2184 25.814 27.2184Z" fill="#0068FF" />
      <path d="M40.4867 19.6162C37.8516 19.6162 35.7095 21.7584 35.7095 24.3934C35.7095 27.0285 37.8516 29.1707 40.4867 29.1707C43.1217 29.1707 45.2639 27.0285 45.2639 24.3934C45.2639 21.7584 43.1217 19.6162 40.4867 19.6162ZM40.4867 27.2181C38.9322 27.2181 37.681 25.9669 37.681 24.4124C37.681 22.8579 38.9322 21.6067 40.4867 21.6067C42.0412 21.6067 43.2924 22.8579 43.2924 24.4124C43.2924 25.9669 42.0412 27.2181 40.4867 27.2181Z" fill="#0068FF" />
      <path d="M29.4562 29.0944H30.5747V19.957H28.6221V28.2793C28.6221 28.7153 29.0012 29.0944 29.4562 29.0944Z" fill="#0068FF" />
    </svg>
  ),
  TT: <span className="material-symbols-outlined text-[12px]">video_library</span>,
  FB: <span className="material-symbols-outlined text-[12px]">social_leaderboard</span>,
  VL: <span className="material-symbols-outlined text-[12px]">storefront</span>,
};
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 text-[10px] text-[#9da6b9]">
        {platformIcons[platform] || <span className="material-symbols-outlined text-[12px]">public</span>}
        <span>{platform}</span>
      </div>
